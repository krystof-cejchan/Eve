...
public class Skip_toSongbyTitle implements ISlashCommands {
    @Override
    ...
    public OptionData getOptionData() {
        return new OptionData(OptionType.STRING, Objects.requireNonNull(getArgName()), "title of the song to be skipped to",
                true, true);
    }
