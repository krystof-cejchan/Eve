<?php
//http://eveuwu.g6.cz/memes/IMemes.php?profpic1=https://i.kym-cdn.com/entries/icons/mobile/000/037/458/coverpal.jpg&rnd=6
...
function ScrollofTruth($user_)
{


    if ((assert($_GET['profpic1']) && empty($_GET['profpic1']) == false)) {
        $bcg_ = 'https://imgflip.com/s/meme/The-Scroll-Of-Truth.jpg';
