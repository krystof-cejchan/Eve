...
public class StartUp {
	...
	public static void main(String[] args) throws LoginException {
		...
		// jda =
		// JDABuilder.createDefault("OTMzNDgyMTE1MDM3ODEwNzI5.YeiK9w.k3jvmDgGu5Qgk_19dVk7d8CY9IY");
		...
		/*
		 * DiscordApi api = new
		 * DiscordApiBuilder().setToken("yourtokenhere").login().join();
		 * api.addVoiceStateUpdateListener(event -> { event.getChannel().); });
		 */
	}
