...
public class PlayerManager_PURE {
    private static PlayerManager_PURE INSTANCE;

    private final Map<Long, GuildMusicManager> MUSICMANAGERS;
    private final AudioPlayerManager AUDIOPLAYERMANAGER;


    public PlayerManager_PURE() {
     ...
     */
    public static PlayerManager_PURE getInstance() {
        if (INSTANCE == null) {
            INSTANCE = new PlayerManager_PURE();
        }
        return INSTANCE;
    }
